...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 28 - Supporting Healthy Friendships & Communication</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 28: Healthy Friendships & Communication</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Help your teen build strong friendships and communicate effectively.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Friendships Matter -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Friendships & Communication Are Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Friendships help teens develop social skills, empathy, and a sense of belonging. Healthy communication strengthens relationships and supports emotional well-being.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          As a parent, guiding your teen in choosing supportive friends and modeling positive communication habits can build trust and confidence.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/talking.jpg" alt="Teen friends talking" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Tips for Supporting Friendships -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Encourage Positive Friendships</h3>
        <p class="text-gray-600 leading-relaxed">Talk about qualities of a healthy friend and encourage relationships based on respect and support.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Model Good Communication</h3>
        <p class="text-gray-600 leading-relaxed">Show active listening, empathy, and respectful disagreement in your own conversations.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Set Boundaries</h3>
        <p class="text-gray-600 leading-relaxed">Teach your teen to say no when necessary and respect others’ boundaries.</p>
      </div>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
  <div class="flex justify-center slide-left">
    <img src="../images/yeah.jpg" alt="Teens building healthy friendships" class="rounded-2xl shadow-lg w-full h-72 object-cover">
  </div>
  <div>
    <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">
      Supporting Healthy Friendships & Communication
    </h2>
    <ul class="space-y-3 text-gray-700 slide-bottom">
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Listen actively when friends are speaking without interrupting</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Express feelings honestly but respectfully</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Respect differences in opinions, backgrounds, and choices</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Support friends in making positive decisions and avoiding harmful ones</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Practice resolving conflicts calmly instead of ignoring or escalating them</li>
    </ul>
  </div>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Supporting Teens</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage open conversations about friendships and feelings.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Help your teen recognize healthy vs. toxic relationships.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Celebrate social successes and positive communication efforts.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Criticize friends harshly—guide instead of controlling.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore conflicts or bullying—they need guidance.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force friendships; let them develop naturally.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/healthyrs.jpg" alt="Parent guiding teen" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Supporting Healthy Friendships & Communication
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/bDANT5FC6Fo?autoplay=1&mute=1&vq=hd1080"
          title="How To Help Your Teen Make Friends"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    A helpful video for parents that models how to guide teens in making friends, navigating peer dynamics, and building confidence in social settings.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about your teen's social life and your role in supporting it:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which friendships does my teen need guidance with?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I model effective communication?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I support conflict resolution without taking over?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which is a sign of a healthy teen friendship?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Mutual respect and support</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Constant arguments and jealousy</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">One-sided control</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. How can a parent model good communication?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">By listening actively and speaking respectfully</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">By interrupting and lecturing constantly</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">By ignoring teen's opinions</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
   You’re supporting your teen in building strong friendships and effective communication skills. Continue to Lesson 29 for more guidance.
  </p>
  <a id="lesson29Btn" href="lesson29.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 29</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson29Btn = document.getElementById('lesson29Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson29Btn){
        lesson29Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 28})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
