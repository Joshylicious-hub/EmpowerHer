...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 4 - Feeding & Burping Basics</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 4: Feeding & Burping Basics</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
       Learn the essentials of nourishing your baby and why burping after feeding keeps them comfortable and healthy.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Feeding & Burping Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Feeding & Burping Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Feeding provides your baby with the nutrients needed for healthy growth and development. Burping helps release swallowed air, preventing discomfort, spit-ups, and colic.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Establishing good feeding and burping habits early ensures your baby feels secure, satisfied, and comfortable after meals.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/feeding1.jpg" alt="Feeding baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Key Feeding Practices -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Responsive Feeding</h3>
        <p class="text-gray-600 leading-relaxed">Feed when your baby shows signs of hunger, not just by the clock.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Proper Latch</h3>
        <p class="text-gray-600 leading-relaxed">Ensure a good latch during breastfeeding for comfort and effectiveness.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Slow Feeding</h3>
        <p class="text-gray-600 leading-relaxed">Allow babies time to feed at their own pace to avoid overfeeding.</p>
      </div>
    </div>

    <!-- Section 3: Burping Techniques -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/feeding2.jpg" alt="Burping baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Burping Techniques</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Hold baby upright against your shoulder and gently pat their back.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Sit baby on your lap, support their head, and rub or pat their back.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Lay baby across your lap on their tummy and gently rub their back.</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
  <div>
    <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Feeding and Burping</h2>
    <ul class="space-y-3 text-gray-700 slide-bottom">
      <li><span class="text-green-600 font-bold">✔ Do:</span> Hold your baby in a semi-upright position while feeding to help prevent choking.</li>
      <li><span class="text-green-600 font-bold">✔ Do:</span> Burp your baby after every feeding by gently patting or rubbing their back.</li>
      <li><span class="text-green-600 font-bold">✔ Do:</span> Watch for hunger cues like sucking hands or rooting instead of waiting for crying.</li>
      <li><span class="text-red-500 font-bold">✘ Don’t:</span> Lay your baby flat during or immediately after feeding, as it may cause discomfort or spit-up.</li>
      <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force your baby to finish a bottle if they show signs of fullness (turning head away, slowing down).</li>
      <li><span class="text-red-500 font-bold">✘ Don’t:</span> Skip burping, even if your baby seems fine—it helps release swallowed air and prevents gas.</li>
    </ul>
  </div>
  <div class="flex justify-center slide-left">
    <img src="../images/feeding3.jpg" alt="Mother feeding and burping baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
  </div>
</div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Feeding & Burping Basics
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/d8tJimekFGo?autoplay=1&mute=1&vq=hd1080"
          title="Baby basics: How to burp your baby"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Learn simple and safe techniques for burping your baby, helping relieve gas and promote comfortable feeding routines.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">Consider your baby’s last feeding session:</p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Did I notice my baby’s hunger cues before feeding?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Was I able to burp my baby effectively afterward?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I make feeding more comfortable for both of us?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Why is burping important after feeding?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It helps release swallowed air and prevents discomfort</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It helps baby fall asleep faster</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It makes baby eat more</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. When should you feed your baby?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">When they show hunger cues</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Only at a strict schedule</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">When they cry loudly</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re learning the best ways to feed and comfort your baby. Continue to Lesson 5 to explore early sensory stimulation and bonding through touch and play.
  </p>
  <a id="lesson5Btn" href="lesson5.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 5</a>
</div>
<!-- hanggang dito -->
  ...
  <script>
    ...
    function checkAnswer(button, isCorrect){
      if(isCorrect){
        ...
        alert("Correct! You're keeping your baby comfortable, Mama!");
      } else {
        button.classList.add('incorrect');
        button.classList.remove('correct');
        alert("Not quite. Think again about feeding and burping basics.");
      }
    }
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5){
      ...
      fetch('../mark_lesson_completed.php', { // ../ because lesson4.php is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 4})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
          console.log("Lesson 4 marked complete");
        }
      });
    }
  });
