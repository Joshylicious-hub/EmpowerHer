...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 18 - Managing Conflicts & Emotions</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 18: Managing Conflicts & Emotions</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
       Learn how to help your child express emotions, handle frustration, and resolve conflicts in a healthy way.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Emotional Awareness Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Children experience many emotions daily, from happiness to frustration. Helping them identify and express feelings safely builds emotional intelligence and stronger relationships.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          For single mothers, guiding your child through conflicts calmly models patience, problem-solving, and empathy.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/angry.jpg" alt="Child expressing emotions" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Tips for Managing Conflicts -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Stay Calm</h3>
        <p class="text-gray-600 leading-relaxed">Your calm behavior helps your child regulate their emotions during conflicts.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Use Words</h3>
        <p class="text-gray-600 leading-relaxed">Encourage your child to describe feelings instead of acting out physically.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Teach Solutions</h3>
        <p class="text-gray-600 leading-relaxed">Guide your child to find fair solutions, like taking turns or compromising with peers.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/mad.jpg" alt="Children resolving conflict" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Practical Activities</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Role-play sharing and problem-solving</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Use emotion cards to name feelings</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Read stories about friendship and empathy</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Practice deep breathing or calm-down routines</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Handling Emotions</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Listen patiently and validate feelings</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Teach healthy ways to express anger and frustration</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage problem-solving and compromise</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Yell or punish emotions harshly</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore conflicts or emotions</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Solve every conflict for your child—let them practice</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/listen.jpg" alt="Mother guiding child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Managing Conflicts & Emotions
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/bwknb9Lw7vI?autoplay=1&mute=1&vq=hd1080"
          title="Frustration! Managing Emotions for Kids"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This video shows simple, relatable scenarios where toddlers learn to understand big feelings, calm down using words or deep breaths, and solve conflicts with help from caring adults.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Reflect on your child’s emotions and your approach:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How does my child express frustration or anger?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which techniques help them calm down most effectively?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I model healthy emotional responses during conflicts?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is a key step in helping a child manage anger?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Encourage them to name their feelings</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore the anger and wait</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Punish them immediately</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which activity helps children practice problem-solving?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Role-playing sharing and conflict resolution</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Avoiding conflicts completely</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Letting the child dominate peers</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re guiding your child to handle emotions and conflicts effectively. Continue to Lesson 19 for more support and strategies.
  </p>
  <a id="lesson19Btn" href="lesson19.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 19</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson19Btn = document.getElementById('lesson19Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson19Btn){
        lesson19Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 18})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
