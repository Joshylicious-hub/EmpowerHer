...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 29 - Encouraging Critical Thinking & Problem Solving</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-8">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 29: Critical Thinking & Problem Solving</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Develop problem-solving skills and think critically about everyday challenges.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Critical Thinking Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Critical Thinking is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Critical thinking helps children make informed decisions, solve problems creatively, and navigate challenges with confidence.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Encouraging your child to ask questions, evaluate choices, and think logically lays a strong foundation for academic and life success.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/encourage.jpg" alt="Child thinking creatively" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Ways to Encourage Problem Solving -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Ask Open-Ended Questions</h3>
        <p class="text-gray-600 leading-relaxed">Encourage your child to explain their reasoning and explore different solutions.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Encourage Exploration</h3>
        <p class="text-gray-600 leading-relaxed">Provide opportunities to experiment, test ideas, and learn from mistakes.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Use Real-Life Problems</h3>
        <p class="text-gray-600 leading-relaxed">Involve your child in age-appropriate decision-making at home or school.</p>
      </div>
    </div>

    <!-- Section 3: Everyday Activities -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/problem.jpg" alt="Child solving a puzzle" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Activities to Boost Thinking</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Brain teasers and puzzles</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Discussing “what if” scenarios</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Planning and organizing small projects</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Reflecting on mistakes and solutions</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Supporting Thinking</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage curiosity and asking questions.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Praise effort and creative problem-solving.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Guide gently without giving all the answers.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Criticize wrong answers—mistakes are learning opportunities.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Rush decision-making; allow thinking time.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Solve problems for them instead of guiding.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/solving.jpg" alt="Parent guiding child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Encouraging Critical Thinking & Problem Solving
  </h2>
  ...
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This video guides parents on teaching problem-solving by encouraging open-ended questions,
    reflection, and confidence in making decisions—helping teens build critical thinking for real-life situations.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Consider your child’s current problem-solving approach:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What challenges could they practice thinking through?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I encourage them to explore multiple solutions?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which strategies help them stay calm and think clearly?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which activity encourages critical thinking?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Solving age-appropriate puzzles</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Giving all the answers immediately</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignoring questions they ask</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What is a good approach when a child makes a mistake?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Guide them to reflect and find solutions</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Scold them for being wrong</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Solve the problem yourself immediately</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Awesome Work! 💖</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
   You are helping your child grow into a confident thinker. Continue to Lesson 30 for more strategies.
  </p>
  <a id="lesson30Btn" href="lesson30.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 30</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson30Btn = document.getElementById('lesson30Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson30Btn){
        lesson30Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 29})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
