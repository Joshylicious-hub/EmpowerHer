...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 26 - Supporting Your Teen: Time Management & Goal Setting</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 26: Time Management & Goal Setting</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
     Learn how to guide your teen in managing their time while staying connected as a parent.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Time Management Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Helping Your Teen Manage Time Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Teens often struggle with balancing school, activities, and personal interests. Your guidance can help them stay organized, reduce stress, and make thoughtful choices.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Supporting them in goal setting and prioritizing tasks encourages independence, responsibility, and confidence.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/time.jpg" alt="Parent supporting teen planning" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Goal Setting Steps -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Guide SMART Goals</h3>
        <p class="text-gray-600 leading-relaxed">Help your teen create Specific, Measurable, Achievable, Relevant, and Time-bound goals for school, hobbies, and personal growth.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Prioritize Together</h3>
        <p class="text-gray-600 leading-relaxed">Work with your teen to list important tasks and deadlines, helping them focus on what matters most.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Track Progress & Celebrate</h3>
        <p class="text-gray-600 leading-relaxed">Encourage your teen to review progress weekly. Celebrate accomplishments and discuss adjustments if needed.</p>
      </div>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
  <div class="flex justify-center slide-left">
    <img src="../images/support.jpg" alt="Teen studying and planning goals" class="rounded-2xl shadow-lg w-full h-72 object-cover">
  </div>
  <div>
    <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">
      Supporting Your Teen – Time Management & Goal Setting
    </h2>
    <ul class="space-y-3 text-gray-700 slide-bottom">
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Create a daily or weekly schedule for school, rest, and hobbies</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Break large tasks into smaller, manageable steps</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Set realistic goals and celebrate small achievements</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Encourage short breaks to recharge and avoid burnout</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Limit distractions (phones, social media) during study time</li>
    </ul>
  </div>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Supporting Your Teen</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage your teen to set realistic goals and guide them in planning.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Offer support and praise when they complete tasks or achieve goals.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Listen to your teen’s ideas and involve them in decision-making.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Micromanage or do tasks for your teen—let them learn responsibility.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Overlook their emotional needs while focusing on achievements.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Criticize mistakes harshly—encourage learning from them instead.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/supporting.jpg" alt="Parent guiding teen" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Helping Your Teen Set Goals & Manage Time
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/-W-wqUFnpak?autoplay=1&mute=1&vq=hd1080"
          title="How to Help Your Teen Set Goals and Stay Motivated"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Practical strategies for parents to support teens in setting meaningful goals, staying motivated, and balancing schoolwork with personal life.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I guide my teen to manage time without taking control?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which strategies can I use to celebrate small successes?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I support my teen when they make mistakes in planning?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which is a good way to help your teen set goals?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Guide them in setting SMART goals</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Do everything for them</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore their goals completely</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which is a helpful approach for daily time management?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Encourage breaking tasks into smaller steps</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Push them to do everything at once</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore deadlines entirely</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Well Done! 💖</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’ve learned practical ways to guide your teen in managing time and setting goals. Continue to Lesson 27 to learn about supporting healthy tech habits.
  </p>
  <a id="lesson27Btn" href="lesson27.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 27</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson27Btn = document.getElementById('lesson27Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson27Btn){
        lesson27Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 26})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
