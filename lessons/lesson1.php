...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 1 - Bonding & Skin-to-Skin Contact</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 1: Bonding & Skin-to-Skin Contact</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Discover how simple moments of closeness build trust, love, and security between you and your child.
    </p>
...
<!-- wala ako pinalitan dito -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Bonding is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Bonding is more than just physical closeness—it creates an emotional foundation that makes your child feel safe and loved. For single mothers, these moments of connection are powerful reminders that you are enough for your child.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Skin-to-skin contact, gentle touch, and responsive care build trust, reduce stress, and encourage healthy growth for both you and your child.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/babycare.jpg" alt="Parent holding baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Skin-to-Skin</h3>
        <p class="text-gray-600 leading-relaxed">Hold your baby close on your chest. It calms them, regulates their breathing, and deepens your connection.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Gentle Voice</h3>
        <p class="text-gray-600 leading-relaxed">Talk or sing softly. Your voice is comforting and helps your baby feel secure.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Responsive Care</h3>
        <p class="text-gray-600 leading-relaxed">Respond to cries with patience—feeding, changing, or cuddling shows your child they can rely on you.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/attachment.jpg" alt="Parent playing with baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Easy Activities You Can Try</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Cuddle while reading or telling a story</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Sing or hum while rocking your baby</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Maintain eye contact while feeding</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Give gentle massages during bath time</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Bonding</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Hold your baby skin-to-skin to calm and comfort them.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Talk or sing softly to help your baby recognize your voice.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Respond quickly and gently when your baby cries.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore your baby’s signals or cries for attention.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Overstimulate your baby with loud noises or rough play.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Skip bonding time even if you’re tired—small moments count.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/royal.jpg" alt="Mother bonding with baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  ...
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Discover the benefits of immediate skin-to-skin contact—such as better breastfeeding, reduced stress, and stronger mother-child bonding.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> When was the last time I held my child close just to comfort them?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which bonding activity feels easiest for me to try daily?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I feel emotionally when I spend quiet time with my child?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is one major benefit of skin-to-skin contact?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It helps babies feel safe and calm</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It makes babies independent instantly</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It replaces the need for feeding</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which of the following is a simple bonding activity?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Singing to your baby while holding them</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Leaving the baby alone for long periods</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Skipping routines to avoid boredom</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <a id="lesson2Btn" href="lesson2.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 2</a>
</div>
<!-- hanggang dito -->
