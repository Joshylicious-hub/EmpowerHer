...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 31 - Helping Your Teen Cope with Stress & Emotions</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-7">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 31: Help Your Teen Cope with Stress & Emotions</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Help teenager’s emotional health and resilience in everyday life.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Understanding Teen Stress -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Teens Experience Stress</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Teenagers face social pressures, academic challenges, and hormonal changes that affect their emotions. Understanding these factors can help you respond with empathy and support.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          As a parent, your guidance, patience, and active listening can significantly improve your teen’s emotional well-being.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/stress.jpg" alt="Teenager feeling stressed" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Ways to Support Your Teen -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Active Listening</h3>
        <p class="text-gray-600 leading-relaxed">Encourage your teen to share feelings without judgment, and listen with empathy.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Encourage Healthy Habits</h3>
        <p class="text-gray-600 leading-relaxed">Support regular exercise, balanced meals, and sufficient sleep to reduce stress.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Model Emotional Coping</h3>
        <p class="text-gray-600 leading-relaxed">Demonstrate healthy coping strategies like deep breathing, journaling, or mindfulness.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/management.jpg" alt="Parent with teen" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        ...
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Set aside time to talk about their day</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Do physical activities together like walking or yoga</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Encourage journaling or creative hobbies</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Practice breathing exercises or guided relaxation</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        ...
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage open conversations</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Validate their feelings without judgment</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Offer guidance and healthy coping strategies</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Dismiss or belittle their emotions</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force them to talk when they’re not ready</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Compare them to peers or siblings</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/emotion.jpg" alt="Parent guiding teen" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Helping Your Teen Cope with Stress & Emotions
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/jKnpHRI-vOg?autoplay=1&mute=1&vq=hd1080"
          title="Stress Management and Coping Plan: Managing Emotions"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    In this video, Dr. Ken Ginsburg explains how teens—and parents—can identify stress triggers, validate emotions, and use simple, practical strategies to cope in the moment.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about how you can apply these strategies in daily life:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I listen actively to my teen today?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What healthy coping habits can we practice together?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How will I validate their emotions without judgment?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which of the following is a healthy way to help your teen cope with stress?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Encourage them to talk about feelings</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore their emotions</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Force them to follow strict rules without explanation</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What should you avoid when supporting your teen emotionally?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Belittling their feelings</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Offering empathy and guidance</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Encouraging healthy habits</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">You’re Doing Great! 💖</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
     Keep supporting your teen’s emotional growth. Continue to Lesson 32 for more tips and guidance.
  </p>
  <a id="lesson32Btn" href="lesson32.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 32</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson32Btn = document.getElementById('lesson32Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson32Btn){
        lesson32Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 31})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
