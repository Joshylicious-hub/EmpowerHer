...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 21 - Building Responsibility with Chores</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-10">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 21: Building Responsibility with Chores</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn how introducing age-appropriate chores can help your child develop responsibility, independence, and confidence.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Chores Matter -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Assigning Chores is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Chores teach children responsibility, time management, and teamwork. Completing tasks helps them feel accomplished and builds life skills that last a lifetime.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          For single mothers, assigning chores also provides opportunities to bond with your child while fostering independence and accountability.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/chores.jpg" alt="Child doing chores" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Age-Appropriate Chores -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Toddlers (2-3 yrs)</h3>
        <p class="text-gray-600 leading-relaxed">Simple tasks like putting toys in a bin or helping set the table.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Preschoolers (4-5 yrs)</h3>
        <p class="text-gray-600 leading-relaxed">Making the bed, watering plants, or folding small clothing items.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">School-Age (6+ yrs)</h3>
        <p class="text-gray-600 leading-relaxed">Sweeping, washing dishes, feeding pets, and helping prepare meals.</p>
      </div>
    </div>

    <!-- Section 3: Daily Chore Tips -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/assign.jpg" alt="Parent supervising chores" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Tips for Successful Chores</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Start with simple tasks and gradually increase difficulty</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Set a routine and consistent schedule for chores</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Offer praise and encouragement for completed tasks</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Join in initially to model how chores are done</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Assigning Chores</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Give clear instructions and demonstrate tasks</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Offer age-appropriate responsibilities</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Praise effort rather than perfection</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Punish or scold for mistakes</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Assign chores that are too difficult or unsafe</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Skip positive reinforcement</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/sweep.jpg" alt="Child doing chores" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Building Responsibility with Chores
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/Vz4kORv-c9s?autoplay=1&mute=1&vq=hd1080"
          title="Why Chores For Kids Matter | And How To Use Chores Effectively"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Learn why giving your child regular chores builds confidence, work ethic, empathy, and independence—and how to introduce them in a fair, motivating way.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about how chores can be integrated in your home:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which chores are appropriate for my child's age?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I encourage responsibility without pressure?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How will I celebrate completed chores?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is the main purpose of assigning chores to children?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">To teach responsibility and independence</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">To punish them for misbehavior</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">To make them do all work alone</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which is an age-appropriate chore for a preschooler?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Folding small clothing items</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Cooking a full meal alone</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Washing large windows</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  You’re helping your child develop responsibility and independence. Continue to Lesson 22 for more practical guidance.
  </p>
  <a id="lesson22Btn" href="lesson22.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 22</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson22Btn = document.getElementById('lesson22Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson22Btn){
        lesson22Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 21})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
