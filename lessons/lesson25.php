...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 25 - Healthy Eating & Active Lifestyle</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 25: Healthy Eating & Active Lifestyle</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn how balanced nutrition and regular physical activity can boost your energy, mood, and overall well-being.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Healthy Lifestyle Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Healthy Eating & Active Lifestyle Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Eating nutritious foods and staying active helps you maintain energy, improve mood, and strengthen your body. For mothers, it also sets a positive example for your child’s habits.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Small changes, like adding fruits and vegetables, drinking enough water, and incorporating movement into your day, create lasting benefits for both you and your family.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/healthy.jpg" alt="Healthy food on a table" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        ...
        <p class="text-gray-600 leading-relaxed">Include fruits, vegetables, whole grains, and lean proteins in your meals for optimal health.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Physical Activity</h3>
        <p class="text-gray-600 leading-relaxed">Aim for daily movement—walking, stretching, or light exercise keeps your body strong and energized.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Hydration & Rest</h3>
        <p class="text-gray-600 leading-relaxed">Drink enough water and prioritize sleep to support recovery, focus, and overall well-being.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/kids.jpg" alt="Mother doing light exercise" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Simple Ways to Practice Healthy Habits</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Drink at least 8 glasses of water per day</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Include vegetables or fruits in every meal</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Take short walks or do stretching exercises daily</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Limit sugary snacks and processed foods</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for a Healthy Lifestyle</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Eat balanced meals with a variety of nutrients</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Engage in enjoyable physical activity daily</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Get enough rest and prioritize sleep</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Skip meals or rely on junk food</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Stay sedentary for long periods</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore signs of fatigue or stress</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/hey.jpg" alt="Healthy lifestyle tips" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Healthy Eating with MyPlate
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/vIkefHZ-SnA?autoplay=1&mute=1&vq=hd1080"
          title="Let’s Play a Game: My Plate with Miss Lisa"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Join Miss Lisa in this fun, interactive video that teaches kids about balanced eating using the MyPlate approach—learning the five food groups, what they do for our bodies, and how to build healthy meals with everyday foods.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about your current lifestyle and how you can make small improvements:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How balanced are my meals each day?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How much physical activity do I get daily?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What small changes can I make to improve my energy and health?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which of the following is part of a balanced diet?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Fruits, vegetables, and lean protein</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Sugary snacks only</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Fast food daily</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which habit supports an active lifestyle?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Taking short walks every day</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Sitting for long hours without moving</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Skipping all exercise</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Great Job! 🌿</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
     Keep practicing healthy eating and staying active! Continue to Lesson 26 for more guidance.
  </p>
  <a id="lesson26Btn" href="lesson26.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 26</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson26Btn = document.getElementById('lesson26Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson26Btn){
        lesson26Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 25})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
