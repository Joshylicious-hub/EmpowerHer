...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 15 - Gentle & Positive Discipline</title>
  ...
  <style>
    ...
    .slide-left.active, .slide-bottom.active { opacity: 1; transform: translateX(0) translateY(0); }
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 15: Gentle & Positive Discipline</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn how calm guidance and positive reinforcement help your child develop good habits and emotional intelligence.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Gentle Discipline Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Gentle Discipline Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Gentle discipline helps children learn self-control, responsibility, and empathy without fear or punishment. It strengthens the parent-child relationship and builds trust.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Using positive reinforcement, clear expectations, and calm guidance encourages children to make better choices while feeling safe and supported.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/discipline1.jpg" alt="Parent guiding child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Set Clear Rules</h3>
        <p class="text-gray-600 leading-relaxed">Explain expectations in simple language. Consistency helps children understand boundaries.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Positive Reinforcement</h3>
        <p class="text-gray-600 leading-relaxed">Praise good behavior and effort, not just results. Encouragement motivates better choices.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Redirection & Choices</h3>
        <p class="text-gray-600 leading-relaxed">Redirect negative behavior safely and offer choices to empower your child’s decision-making.</p>
      </div>
    </div>

    <!-- Section 3: Everyday Scenarios -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/discipline2.jpg" alt="Parent giving choices" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Try These Approaches Daily</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Give simple choices instead of commands</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Explain why a behavior is not safe</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Use calm tones, even during tantrums</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Praise small improvements to encourage repetition</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Gentle Discipline</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Stay calm and consistent in responses</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Explain rules and consequences clearly</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Reinforce positive behavior with praise</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Yell, hit, or use fear-based punishments</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Overreact to minor misbehavior</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore feelings or needs of your child</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/good.jpg" alt="Gentle discipline tips" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Gentle & Positive Discipline
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/X9rgco3CEHE?autoplay=1&mute=1&vq=hd1080"
          title="Positive Toddler Discipline: Nurturing Growth and Encouraging Good Behavior"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This video walks you through calm, respectful responses to toddler behavior challenges—helping build cooperation, understanding, and emotional intelligence.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Take a moment to think about your approach to discipline:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I respond when my child misbehaves?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which gentle strategies feel easiest for me to practice daily?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I encourage positive behavior more effectively?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is one major benefit of gentle discipline?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Helps children learn without fear</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Makes children behave instantly without guidance</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Replaces the need for teaching rules</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which method encourages positive behavior?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Praise good choices and effort</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore all behavior</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Yell to correct mistakes</button>
        </div>
      </div>

      <!-- Question 3 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">3. Which action is NOT recommended in gentle discipline?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Redirecting a tantrum safely</button>
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Yelling or hitting</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Offering simple choices</button>
        </div>
      </div>
    </div>

    <!-- Section 8: Extra Tips -->
    <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      <h2 class="text-3xl font-semibold text-gray-800 mb-4 text-center slide-left">Extra Tips for Gentle Discipline</h2>
      <ul class="space-y-3 text-gray-700 slide-bottom list-disc list-inside">
        <li>Keep routines consistent to reduce conflicts.</li>
        <li>Use “I” statements: "I feel upset when toys are thrown."</li>
        <li>Model desired behaviors through your own actions.</li>
        <li>Take a moment to breathe if frustrated.</li>
        <li>Celebrate small successes to reinforce learning.</li>
      </ul>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Well Done, Mama! 🌸</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You are creating a nurturing environment that teaches and guides your child with love. Keep practicing gentle discipline strategies every day.
  </p>
  <a id="lesson16Btn" href="lesson16.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 16</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson16Btn = document.getElementById('lesson16Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson16Btn){
        lesson16Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 15})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
