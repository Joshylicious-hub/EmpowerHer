...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 24 - Problem-Solving & Critical Thinking</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-10">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 24: Problem-Solving & Critical Thinking</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn how to approach challenges thoughtfully, make decisions, and develop creative solutions in everyday life.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Problem-Solving Skills Matter</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Problem-solving and critical thinking help children and adults navigate challenges, make informed choices, and think creatively. These skills build confidence and independence.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Developing these abilities early encourages curiosity, logical reasoning, and the ability to adapt to unexpected situations.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/thinking.jpg" alt="Thinking and problem-solving" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Identify the Problem</h3>
        <p class="text-gray-600 leading-relaxed">Understand the situation clearly before trying to solve it. Ask questions and gather information.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Brainstorm Solutions</h3>
        <p class="text-gray-600 leading-relaxed">Think of multiple ways to solve the problem. Be creative and consider different perspectives.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Evaluate & Decide</h3>
        <p class="text-gray-600 leading-relaxed">Weigh pros and cons, predict outcomes, and choose the solution that works best.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/critical.jpg" alt="Children solving problems together" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Try These Activities</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Solve puzzles or brain teasers with friends or family</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Play strategy games that require planning and thinking</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Discuss real-life problems and suggest multiple solutions</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Reflect on past challenges and think of alternative approaches</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        ...
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Break problems into smaller, manageable parts</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Think creatively and consider multiple solutions</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Reflect on your decisions and learn from mistakes</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Rush to conclusions without understanding the problem</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore other people's ideas or solutions</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Give up too quickly when challenges arise</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/nonya.jpg" alt="Thinking critically" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Teaching Problem-Solving & Critical Thinking
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/s6REGGsrTx8?autoplay=1&mute=1&vq=hd1080"
          title="How To Teach Problem Solving Skills To Children"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    A knowledgeable parent-educator explains how to guide children toward thinking for themselves—including asking open questions, framing challenges, and encouraging reflection to build confidence and independence.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Consider your own problem-solving approach:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I approach problems in daily life?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which strategies help me think critically and creatively?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I improve my decision-making process?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is the first step in problem-solving?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Identify the problem clearly</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Choose a random solution</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore the problem</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which action demonstrates critical thinking?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Weighing pros and cons before deciding</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Choosing the first idea without analysis</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Avoiding thinking to save time</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
   Keep practicing your problem-solving and critical thinking skills. Continue to Lesson 25 for more guidance.
  </p>
  <a id="lesson25Btn" href="lesson25.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 25</a>
</div>
<!-- hanggang dito -->
  ...
  <script>
    ...
    function checkAnswer(button, isCorrect){
      if(isCorrect){ button.classList.add('correct'); button.classList.remove('incorrect'); alert("Correct! Great job!"); }
      else{ button.classList.add('incorrect'); button.classList.remove('correct'); alert("Oops! Try again."); }
    }

     // Make sure the "Go to Lesson 2" button has this ID
  const lesson25Btn = document.getElementById('lesson25Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson25Btn){
        lesson25Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 24})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
