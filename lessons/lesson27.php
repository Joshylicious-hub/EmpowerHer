...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 27 - Guiding Healthy Technology & Social Media Habits</title>
  <script src="https://cdn.tailwindcss.com"></script>
  <style>
    html { scroll-behavior: smooth; }
    .slide-left, .slide-bottom { opacity: 0; transform: translateX(-50px); transition: all 0.8s ease-out; }
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 ">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 27: Guiding Social Media Habits</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn practical ways to help your teen use technology safely.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Guiding Tech Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Monitoring Technology & Social Media is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Adolescents spend increasing time online. Guiding your teen helps prevent cyberbullying, screen addiction, and unsafe interactions while promoting healthy digital habits.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          As a single mother, setting boundaries, discussing online behavior, and modeling balanced screen use can strengthen trust and communication with your teen.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/tech.jpg" alt="Parent guiding teen on tablet" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Tips for Healthy Technology Use -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Set Screen Time Limits</h3>
        <p class="text-gray-600 leading-relaxed">Work with your teen to establish daily screen time boundaries for schoolwork, recreation, and family time.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Discuss Online Safety</h3>
        <p class="text-gray-600 leading-relaxed">Talk about privacy, sharing personal information, and recognizing online risks like cyberbullying or scams.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Encourage Positive Use</h3>
        <p class="text-gray-600 leading-relaxed">Guide your teen to use social media for learning, creativity, and connecting with friends safely.</p>
      </div>
    </div>

   <!-- Section 3: Practical Activities -->
<div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
  <div class="flex justify-center slide-left">
    <img src="../images/comp.jpg" alt="Teens using computer responsibly" class="rounded-2xl shadow-lg w-full h-72 object-cover">
  </div>
  <div>
    <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">
      Guiding Healthy Technology & Social Media Habits
    </h2>
    <ul class="space-y-3 text-gray-700 slide-bottom">
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Set daily screen time limits and take regular breaks</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Practice a “tech-free hour” before bedtime</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Review privacy settings together on social media accounts</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Encourage using devices for learning, hobbies, or creativity—not just scrolling</li>
      <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Model respectful online communication and kindness</li>
    </ul>
  </div>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Guiding Teens Online</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Set clear screen time rules together with your teen.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Talk openly about online experiences and feelings.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Model healthy tech habits yourself.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Spy on your teen excessively—build trust instead.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Overreact to small mistakes—they are learning.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Allow unrestricted access without guidance.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/teens.jpg" alt="Mother and teen on tablet" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

   <!-- Section 4: Video & Discussion -->
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: 3 Ways to Help Teens Manage Screen Time
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/QIujG-rYQvQ?autoplay=1&mute=1&vq=hd1080"
          title="3 Ways to Help Teens Manage Screen Time – Dr Lisa Damour UNICEF"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Dr. Lisa Damour shares practical, respectful ways to help teens build healthy screen habits—setting limits, modeling behavior, and keeping communication open.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Consider your own approach to technology and how you guide your teen:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What rules can I set for healthy screen use?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I model balanced tech habits for my teen?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which online risks should I discuss openly with my teen?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which is a healthy approach to screen time for teens?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Set daily screen time limits together</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Let teens use screens all day freely</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Completely ban all technology</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What is a recommended practice for online safety?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Discuss privacy and safe sharing with your teen</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore their online activity completely</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Force them to delete social media accounts</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’ve learned strategies to guide your teen toward safe and balanced technology use. Continue to Lesson 28 for supporting healthy friendships and communication.
  </p>
  <a id="lesson28Btn" href="lesson28.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 28</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson28Btn = document.getElementById('lesson28Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson28Btn){
        lesson28Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 27})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
