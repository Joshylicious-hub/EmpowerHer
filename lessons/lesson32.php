...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 32 - Guiding Safe Decisions & Handling Peer Pressure</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 32: Guiding Safe Decisions & Handling Peer Pressure</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Guide your teen in making safe choices and resisting negative peer influence.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">What is Peer Pressure?</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Peer pressure is the influence friends or classmates may have on your teen to make choices that may not align with their values or safety. Understanding it helps you guide them effectively.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Teens often seek acceptance, so learning to recognize and handle peer pressure is key to safe decision-making.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/peer.jpg" alt="Teen facing peer pressure" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Strategies to Guide Teens -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Open Communication</h3>
        <p class="text-gray-600 leading-relaxed">Talk openly about situations they may face and encourage questions without judgment.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Set Clear Boundaries</h3>
        <p class="text-gray-600 leading-relaxed">Establish rules and expectations while explaining the reasoning behind them.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Role-Playing Scenarios</h3>
        <p class="text-gray-600 leading-relaxed">Practice real-life situations so your teen can learn how to say no confidently.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/pressure.jpg" alt="Parent guiding teen" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Practical Tips</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Encourage critical thinking before making decisions</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Discuss potential consequences of risky choices</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Reinforce positive peer relationships</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Celebrate safe choices and responsible behavior</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        ...
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Listen and validate your teen's concerns</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage open discussions about peer pressure</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Teach refusal skills and confident decision-making</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Dismiss or belittle their fears</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Overreact to mistakes—use them as teaching moments</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore changes in behavior or social circles</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/help.jpg" alt="Teens making decisions" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Guiding Safe Decisions & Handling Peer Pressure
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/xNd6AsRH0WU?autoplay=1&mute=1&vq=hd1080"
          title="FOMO No More: Overcoming Peer Pressure in Teens"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    In this video, teens explore how to recognize and handle peer pressure. It provides strategies for making safe choices,
    resisting negative influence, and finding the confidence to stand up for what feels right.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Consider how you can guide your teen effectively:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I encourage my teen to make safe decisions?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I help them resist negative peer influence?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What strategies can I practice with them to build confidence?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which is an effective way to help your teen handle peer pressure?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Role-play scenarios and practice saying no</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore their concerns</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Force strict rules without explanation</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What should you avoid when guiding your teen?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Belittling or dismissing their feelings</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Discussing consequences openly</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Encouraging safe habits</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Congratulations! 🎉</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
   You’ve completed the course on guiding your teen through safe decision-making and handling peer pressure. Keep using these strategies to support your child every day.
  </p>
  <a id="lesson32Btn" href="../modules.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Back to Modules</a>
</div>
<!-- hanggang dito -->
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 32})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
