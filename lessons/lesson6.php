...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 6 - Tummy Time & Motor Skills</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 6: Tummy Time & Motor Skills</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
     Discover how tummy time supports your baby’s motor development and strengthens their muscles for crawling, sitting, and walking.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Tummy Time Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Tummy Time Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Tummy time helps your baby build strong neck, shoulder, and arm muscles. It also prevents flat spots on the head and prepares them for rolling, crawling, and sitting.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Even a few minutes a day makes a difference. Start early, and increase tummy time gradually as your baby grows stronger.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/tummy1.jpg" alt="Baby during tummy time" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Motor Skills by Stage -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">0–3 Months</h3>
        <p class="text-gray-600 leading-relaxed">Lifts head briefly, turns it side to side, and begins pushing up on arms.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">4–6 Months</h3>
        <p class="text-gray-600 leading-relaxed">Rolls over, supports weight on arms, and begins sitting with help.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">7–12 Months</h3>
        <p class="text-gray-600 leading-relaxed">Crawls, pulls up to stand, and starts cruising along furniture.</p>
      </div>
    </div>

    <!-- Section 3: How to Support Tummy Time -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/tummy2.jpg" alt="Mother supporting tummy time" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">How to Support Tummy Time</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Place your baby on a clean, firm surface for short tummy time sessions daily.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Get down on the floor and interact to encourage movement.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Use toys or a mirror to keep your baby engaged and motivated.</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Tummy Time</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Start tummy time as early as the first week for a few minutes at a time.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Always supervise your baby during tummy time.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Gradually increase tummy time as your baby grows stronger.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Leave your baby unattended on their tummy.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Place your baby on a soft surface like a couch or bed.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force your baby to stay longer than they are comfortable.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/tummy3.jpg" alt="Safe tummy time practice" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Tummy Time & Motor Skills
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/pgeJM3u3_Tw?autoplay=1&mute=1&vq=hd1080"
          title="TummyTime!™️ Method – Tummy Time Routine for Babies"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This video teaches gentle tummy time techniques—like chest positioning and supportive holds—to build your baby’s strength while they learn to lift their head and move safely.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">Think about your tummy time routine:</p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How often do I give my baby tummy time each day?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What activities or toys make tummy time more fun?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I gradually increase tummy time as my baby grows?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Why is tummy time important for babies?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It strengthens muscles needed for crawling and sitting</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It helps babies fall asleep faster</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It replaces feeding sessions</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What should you avoid during tummy time?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Supervising your baby while on the floor</button>
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Leaving your baby unattended on their tummy</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Encouraging tummy time with toys</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <a id="lesson7Btn" href="lesson7.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 7</a>
</div>
<!-- hanggang dito -->
  ...
  <script>
    ...
    function checkAnswer(button, isCorrect){
      if(isCorrect){
        ...
        alert("Correct! You're helping your baby grow strong!");
      } else {
        button.classList.add('incorrect');
        button.classList.remove('correct');
        alert("Not quite. Think about how tummy time supports development.");
      }
    }

     // Make sure the "Go to Lesson 2" button has this ID
  const lesson7Btn = document.getElementById('lesson7Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson7Btn){
        lesson7Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 6})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
          console.log("Lesson 6 marked complete");
        }
      });
    }
  });
