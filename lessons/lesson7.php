...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 7 - Encouraging Babbling & Early Language</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 7: Encouraging Babbling & Early Language</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn how to nurture your baby’s first sounds and encourage the building blocks of language and communication.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Early Language Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Early Language Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Babbling is your baby’s way of practicing speech. Each coo, gurgle, or “ba-ba” is an important step toward real words. 
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          When you respond to your baby’s sounds, you encourage communication and strengthen your bond—helping them feel heard and understood.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/babbling.jpg" alt="Baby babbling" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Language Milestones -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        ...
        <p class="text-gray-600 leading-relaxed">Cooing sounds, smiling, and responding to your voice with gurgles.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">4–6 Months</h3>
        <p class="text-gray-600 leading-relaxed">Babbling with sounds like “ba” or “da” and responding to tones.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">7–12 Months</h3>
        <p class="text-gray-600 leading-relaxed">Combines sounds into “mama” or “dada,” and starts imitating speech patterns.</p>
      </div>
    </div>

    <!-- Section 3: How to Encourage Babbling -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/language.jpg" alt="Mother talking to baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">How to Encourage Babbling</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Talk often to your baby in a warm, playful tone.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Repeat the sounds your baby makes and add simple words.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Use songs, rhymes, and facial expressions to engage them.</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Early Language</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Respond with smiles and words when your baby babbles.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Read and sing daily to expose your baby to language.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage turn-taking in “conversations.”</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore babbling—it’s your baby’s way of talking to you.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Use baby talk only; mix in clear, simple words too.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Get frustrated if words don’t come quickly—it’s a process.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/ignoring.jpg" alt="Parent encouraging baby speech" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Encouraging Babbling & Early Language
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/FL1zlUWov3E?autoplay=1&mute=1&vq=hd1080"
          title="The best way to get your baby babbling"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This video shows simple, fun techniques—like repeating sounds, smiling, and responding—to help your baby start babbling and build early language skills.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">Think about your baby’s communication:</p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I respond when my baby makes sounds?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What songs, words, or stories can I share daily?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I make “conversations” fun and encouraging?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What does babbling help your baby practice?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">The sounds needed for speech</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Learning how to crawl</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Falling asleep faster</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which of these helps encourage babbling?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Talking, singing, and repeating sounds</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Staying silent during playtime</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignoring baby’s coos</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re helping your baby take their first steps in communication. Continue to Lesson 8 to explore play and social skills.
  </p>
  <a id="lesson8Btn" href="lesson8.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 8</a>
</div>
<!-- hanggang dito -->
  ...
  <script>
    ...
    function checkAnswer(button, isCorrect){
      if(isCorrect){
        ...
        alert("Correct! Babbling is the foundation of language.");
      } else {
        button.classList.add('incorrect');
        button.classList.remove('correct');
        alert("Not quite. Think about how babies learn to talk.");
      }
    }

     // Make sure the "Go to Lesson 2" button has this ID
  const lesson8Btn = document.getElementById('lesson8Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson8Btn){
        lesson8Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 7})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
