...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 11 - Toilet Training Made Easy</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 11: Toilet Training Made Easy</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
       Learn effective strategies to help your child transition confidently from diapers to the potty.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Toilet Training Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Toilet Training is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Toilet training is a key milestone in your child’s independence and self-confidence. It helps them develop personal hygiene habits while boosting their sense of accomplishment.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          For single mothers, being patient and consistent ensures a positive experience for both you and your child.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/toilet1.jpg" alt="Parent assisting child with potty" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Signs of Readiness -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Physical Readiness</h3>
        <p class="text-gray-600 leading-relaxed">Can stay dry for 2+ hours, has regular bowel movements, and can pull pants up and down.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Emotional Readiness</h3>
        <p class="text-gray-600 leading-relaxed">Shows interest in using the potty and demonstrates discomfort with dirty diapers.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Communication Skills</h3>
        <p class="text-gray-600 leading-relaxed">Can follow simple instructions and communicate when they need to go.</p>
      </div>
    </div>

    <!-- Section 3: Step-by-Step Tips -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/toilet.jpg" alt="Child using potty" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Steps for Successful Toilet Training</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Introduce the potty and explain its use in simple words</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Establish a consistent schedule (after meals, before bedtime)</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Encourage your child to try, but never force it</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Praise efforts and successes to build confidence</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Toilet Training</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Be patient and maintain a positive attitude</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Celebrate small achievements to motivate your child</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Offer gentle reminders and support</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Punish accidents or express frustration</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Compare your child with others</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Rush the process or skip readiness cues</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/nice.jpg" alt="Parent guiding child with potty" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Toilet Training Made Easy
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/WfDBHfF0ddE?autoplay=1&mute=1&vq=hd1080"
          title="Toilet Training Video for Toddlers – The Goodbye Diapers Song"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This cheerful song makes potty time fun and encourages toddlers to feel proud as they move on from diapers.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about your child’s readiness and your approach:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Is my child showing signs of readiness for toilet training?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I maintain patience and encouragement during training?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What strategies work best for rewarding successes?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which is a sign your child is ready for toilet training?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Stays dry for long periods</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Refuses to sit on the potty at all times</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Cries whenever offered praise</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What is the best approach for accidents?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Stay calm and encourage your child</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Punish the child for accidents</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore them completely</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
   You’re guiding your child toward independence and good hygiene habits. Continue to Lesson 12 for more parenting tips.
  </p>
  <a id="lesson12Btn" href="lesson12.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 12</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson12Btn = document.getElementById('lesson12Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson12Btn){
        lesson12Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 11})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
