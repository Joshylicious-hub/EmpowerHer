...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 12 - Managing Tantrums & Big Emotions</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 12: Managing Tantrums & Big Emotions</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn strategies to understand and manage your child's big emotions while maintaining calm and connection.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Understanding Tantrums -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Children Have Tantrums</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Tantrums are a normal part of development. They are your child’s way of expressing strong emotions they cannot yet regulate.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Understanding the cause—whether frustration, tiredness, or overstimulation—helps you respond calmly and supportively.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/tantrums1.jpg" alt="Child having tantrum" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Recognizing Triggers -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Hunger & Fatigue</h3>
        <p class="text-gray-600 leading-relaxed">Low energy can quickly lead to meltdowns.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Overstimulation</h3>
        <p class="text-gray-600 leading-relaxed">Too much noise or activity can overwhelm a child.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Frustration</h3>
        <p class="text-gray-600 leading-relaxed">Difficulty with tasks or communication can trigger big emotions.</p>
      </div>
    </div>

    <!-- Section 3: Calm & Supportive Responses -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/tantrums2.jpg" alt="Parent comforting child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        ...
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Stay calm and speak in a gentle voice</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Acknowledge their feelings: “I see you are upset”</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Offer comfort and physical reassurance if safe and welcomed</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Remove distractions and create a quiet space if needed</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Managing Tantrums</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Stay calm and patient</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Validate your child's emotions</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Set gentle boundaries and routines</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Yell, punish, or shame your child</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Give in to every demand during a tantrum</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore their emotional needs completely</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/tantrums3.jpg" alt="Parent handling tantrum calmly" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Managing Tantrums & Big Emotions
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/J3eEj6W_1-I?autoplay=1&mute=1&vq=hd1080"
          title="Handling Tantrums in Young Children and Toddlers"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Learn how to stay calm, offer supportive choices, and validate emotions when your toddler is upset—building trust and teaching emotional strength.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about how you handle big emotions:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What triggers my child’s tantrums most often?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I stay calm and supportive during a tantrum?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which calming strategies seem most effective for my child?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is an effective response to a tantrum?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Stay calm and acknowledge their feelings</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Yell or punish immediately</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignore the child entirely</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which is a common tantrum trigger?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Being hungry or tired</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Watching a calm video</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Playing quietly with toys</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re learning to support your child through big emotions while staying calm and connected. Continue to Lesson 13 for more guidance.
  </p>
  <a id="lesson13Btn" href="lesson13.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 13</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson13Btn = document.getElementById('lesson13Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson13Btn){
        lesson13Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 12})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
