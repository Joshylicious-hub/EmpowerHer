...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 10 - Playtime & Social Development</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 10: Playtime & Social Development</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
       Learn how play helps your child grow socially, emotionally, and cognitively while strengthening your bond.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Play is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Playtime is essential for your child’s social and emotional development. Through play, children learn cooperation, communication, problem-solving, and creativity.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          For single mothers, engaging in play strengthens your bond and provides opportunities to nurture confidence and independence in your child.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/play1.jpg" alt="Parent playing with child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Types of Play -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Sensory Play</h3>
        <p class="text-gray-600 leading-relaxed">Activities that engage senses like touch, smell, and sight, helping your child explore and learn about their environment.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Imaginative Play</h3>
        <p class="text-gray-600 leading-relaxed">Role-playing, storytelling, or pretend games that develop creativity, problem-solving, and emotional understanding.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Physical Play</h3>
        <p class="text-gray-600 leading-relaxed">Running, climbing, or dancing activities that strengthen muscles, coordination, and overall health.</p>
      </div>
    </div>

    <!-- Section 3: Playtime Tips -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/play2.jpg" alt="Child playing with blocks" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Tips for Effective Play</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Join your child in play but let them lead the activity</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Rotate toys and activities to keep curiosity alive</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Encourage interaction with peers or siblings for social skills</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Praise efforts and creativity, not just outcomes</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Playtime</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Engage actively and be present during play</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Offer a variety of safe toys and materials</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Allow your child to explore independently sometimes</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force structured activities all the time</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Compare your child’s abilities with others</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore your child’s emotions during play</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/play3.jpg" alt="Child playing with mother" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Playtime & Social Development
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/yICKsGTZ8f0?autoplay=1&mute=1&vq=hd1080"
          title="How to Play With Your 2-Year-Old"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    See fun, simple ideas for engaging your toddler in play—like taking turns, using everyday objects for games, and encouraging imaginative interaction to support social and emotional growth.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Consider how playtime affects your child and your relationship:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which type of play does my child enjoy most?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I create more opportunities for social interaction?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How does playing together make me feel connected to my child?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which is a benefit of imaginative play?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Develops creativity and problem-solving skills</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Replaces the need for sleep</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ensures immediate independence</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What should you avoid during playtime?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Forcing structured activities constantly</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Encouraging creativity</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Joining your child in play</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re supporting your child’s social and emotional growth through play. Continue to Lesson 11 for more guidance.
  </p>
  <a id="lesson11Btn" href="lesson11.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 11</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson11Btn = document.getElementById('lesson11Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson11Btn){
        lesson11Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 10})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
