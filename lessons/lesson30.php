...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 30 - Nutrition, Exercise & Self-Care</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 30: Nutrition, Exercise & Self-Care</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
       Learn how to take care of yourself and your child through healthy habits, proper nutrition, and regular exercise.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Importance of Nutrition & Self-Care -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Nutrition and Self-Care Matter</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Eating well, exercising, and taking time for self-care are essential for your health and your child's well-being. When you prioritize yourself, you can better care for your family.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Healthy routines reduce stress, increase energy, and promote physical and mental wellness for both mother and child.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/self.jpg" alt="Healthy mother and child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Daily Healthy Habits -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Balanced Diet</h3>
        <p class="text-gray-600 leading-relaxed">Include fruits, vegetables, proteins, and whole grains to stay energized and support your child’s growth.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Regular Exercise</h3>
        <p class="text-gray-600 leading-relaxed">Even short walks or light workouts improve mood, stamina, and overall health.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Mental Wellness</h3>
        <p class="text-gray-600 leading-relaxed">Meditation, journaling, or quiet time helps manage stress and keeps you emotionally balanced.</p>
      </div>
    </div>

    <!-- Section 3: Easy Activities -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/care.jpg" alt="Mother exercising" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Simple Activities You Can Try</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Go for a 15-minute walk daily with your child</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Prepare colorful, healthy meals together</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Practice deep breathing or stretching in the morning</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Set aside 10–15 minutes of quiet or self-reflection</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Self-Care</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Eat balanced meals regularly</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Include short exercise sessions daily</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Take quiet moments for mental health</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Skip meals or over-rely on junk food</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Overexert yourself physically</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Neglect emotional well-being</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/nutrition.jpg" alt="Mother practicing self-care" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Healthy Habits for Teens – Nutrition, Exercise & Self-Care
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/fmpAdsuavOg?autoplay=1&mute=1&vq=hd1080"
          title="Teens: My Self-Care"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Join teens in learning easy and realistic self-care habits: eating well, staying active, managing stress, and caring for emotional and physical health.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I improve my diet this week?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which exercises can I include without feeling overwhelmed?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What small actions help me recharge mentally each day?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which of the following is part of a healthy self-care routine?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Eating balanced meals</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Skipping breakfast every day</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignoring sleep needs</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What is a simple way to include exercise in your routine?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Taking a 15-minute walk daily</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Sitting without breaks all day</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Exercising until exhaustion only once a month</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Awesome Work, Mama! 💖</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
     You’re building healthy habits for yourself and your child. Continue to Lesson 31 for more tips and guidance.
  </p>
  <a id="lesson31Btn" href="lesson31.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 31</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson31Btn = document.getElementById('lesson31Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson31Btn){
        lesson31Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 30})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
