...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 13 - Encouraging Creativity & Play</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 13: Encouraging Creativity & Play</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
     Learn how playtime and creative activities foster imagination, problem-solving, and emotional growth in your child.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Importance of Creativity -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Creativity Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Creativity allows children to express themselves, solve problems, and explore the world around them. It builds confidence and curiosity.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Encouraging play and imaginative activities strengthens brain development and emotional intelligence.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/creative1.jpg" alt="Child painting" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        ...
        <p class="text-gray-600 leading-relaxed">Dress-up, role-playing, and pretend games let children explore ideas and emotions.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Creative Arts</h3>
        <p class="text-gray-600 leading-relaxed">Drawing, painting, or crafting encourages self-expression and fine motor skills.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Problem-Solving Games</h3>
        <p class="text-gray-600 leading-relaxed">Puzzles, building blocks, and experiments develop critical thinking and patience.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/creative2.jpg" alt="Parent playing with child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Simple Creative Activities</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Build with blocks or LEGO sets</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Draw, paint, or color together</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Pretend play with toys or costumes</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Simple science experiments using safe household items</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Encouraging Play</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Offer choices and allow free play</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Join in without controlling the activity</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage exploration and curiosity</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Criticize their creations or ideas</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Limit play to only structured activities</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Pressure them to “perform” or compete</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/creativity2.jpg" alt="Parent encouraging play" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Encouraging Creativity & Play
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/vTqJabU0Rx0?autoplay=1&mute=1&vq=hd1080"
          title="Activities for Toddlers: Fun Toddler Games & Activities"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Discover fun, hands-on playtime ideas—like crafts, sensory bins, building forts, and simple puzzles—that inspire imagination and support your toddler’s growth.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about how you can encourage creativity in your child:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What creative activities does my child enjoy most?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I make space for free play at home?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I respond when my child experiments or makes mistakes?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which activity encourages creativity?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Drawing or painting</button>
      ...
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What is a good way to encourage imaginative play?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Provide costumes and props</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Criticize their ideas</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Force them to follow instructions strictly</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
     You’re helping your child explore, imagine, and grow through creative play. Continue to Lesson 14 for more guidance.
  </p>
  <a id="lesson14Btn" href="lesson14.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 14</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson14Btn = document.getElementById('lesson14Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson14Btn){
        lesson14Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 13})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
