...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 19 - Learning Letters, Numbers & Stories</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-14">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 19: Learning Letters, Numbers & Stories</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Explore fun ways to introduce letters, numbers, and stories that nurture curiosity and early literacy skills.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Early Learning Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Early Learning is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Introducing letters, numbers, and stories at an early age helps children develop cognitive, language, and literacy skills. Reading aloud and playful learning foster curiosity and a love for learning.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          For single mothers, these activities strengthen bonding while encouraging your child's intellectual growth and imagination.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/numbers.jpg" alt="Child learning letters" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Fun Learning Activities -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Letter Games</h3>
        <p class="text-gray-600 leading-relaxed">Use colorful flashcards, magnetic letters, or alphabet puzzles to make learning letters fun.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Counting Fun</h3>
        <p class="text-gray-600 leading-relaxed">Count toys, snacks, or steps while moving around—numbers become part of daily life.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Storytime</h3>
        <p class="text-gray-600 leading-relaxed">Read aloud or tell stories daily to enhance vocabulary, imagination, and listening skills.</p>
      </div>
    </div>

    <!-- Section 3: Everyday Learning -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/numbers1.jpg" alt="Mother reading to child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Practical Tips for Daily Learning</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Point out letters and numbers in books, signs, and packaging</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Ask your child to count objects during play</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Make up short, fun stories together</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Sing alphabet or counting songs during daily routines</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Early Learning</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Make learning playful and interactive</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage curiosity and ask questions</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Praise efforts, not just results</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force memorization or drill too hard</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Compare your child with others</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Make learning a stressful experience</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/mothers.jpg" alt="Mother teaching child letters" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Learning Letters, Numbers & Stories
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/K_Aq4H03Nm4?autoplay=1&mute=1&vq=hd1080"
  ...
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Join Ms Rachel in this guided video where she models fun, hands-on ways for parents to teach letters, counting, storytelling, and more with everyday moments.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about how you can integrate letters, numbers, and stories into daily life:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What games or songs can make learning letters fun for my child?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I turn everyday moments into counting opportunities?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which stories or books capture my child's interest most?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which activity helps children learn numbers effectively?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Counting toys or objects during play</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Forcing them to memorize numbers</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignoring numbers completely</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. What is a key benefit of storytelling for young children?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Expands vocabulary and imagination</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Replaces the need for playtime</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Teaches them to read instantly</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re building a strong foundation of love and trust with your child. Scroll to the bottom to unlock Lesson 2.
  </p>
  <a id="lesson20Btn" href="lesson20.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 20</a>
</div>
<!-- hanggang dito -->
  ...
  <script>
    ...
    function checkAnswer(button, isCorrect){
      if(isCorrect){
        button.classList.add('correct'); button.classList.remove('incorrect');
        alert("Correct! Great job, Mama!");
      } else {
        button.classList.add('incorrect'); button.classList.remove('correct');
        alert("Oops! Try again.");
      }
    }

     // Make sure the "Go to Lesson 2" button has this ID
  const lesson20Btn = document.getElementById('lesson20Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson20Btn){
        lesson20Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 19})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
