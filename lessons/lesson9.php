...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 9 - Starting Solid Foods Safely</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 9: Starting Solid Foods Safely</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn when and how to introduce solid foods to your baby safely, ensuring proper nutrition and a smooth transition from milk.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Solid Foods Matter -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Solid Foods Are Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Introducing solids is a key milestone in your baby’s growth. It provides essential nutrients that milk alone may not supply after six months.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Solid foods also help develop chewing skills, hand-eye coordination, and introduce babies to new tastes and textures.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/eating1.jpg" alt="Baby eating solid food" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: First Foods to Try -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Pureed Fruits</h3>
        <p class="text-gray-600 leading-relaxed">Start with soft fruits like banana, pear, or apple to introduce natural sweetness and vitamins.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Vegetable Purees</h3>
        <p class="text-gray-600 leading-relaxed">Soft-cooked veggies like carrots, pumpkin, or peas provide iron and fiber essential for growth.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Iron-Fortified Cereals</h3>
        <p class="text-gray-600 leading-relaxed">Single-grain cereals like rice or oatmeal give your baby iron and help transition to solids.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/food.jpg" alt="Parent feeding baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Tips for Safe Feeding</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Introduce one new food at a time and wait 3–5 days to check for allergies</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Offer small spoonfuls and let your baby explore at their own pace</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Sit your baby upright during meals to reduce choking risk</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Avoid honey, cow’s milk, or choking hazards before age 1</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Solids</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Start with single-ingredient purees</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Observe your baby’s cues for hunger and fullness</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage self-feeding with soft foods as your baby grows</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force your baby to eat more than they want</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Offer sweetened foods or juice</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Leave your baby unattended while eating</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/eating3.jpg" alt="Do's and Don'ts of feeding" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Starting Solid Foods Safely
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/8MPT4PPFHNE?autoplay=1&mute=1&vq=hd1080"
          title="Giving Solid Foods Safely To Your Baby"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This video teaches how to tell if your baby is ready for solids, what safe first foods are, how to avoid choking risks, and tips for easing into feeding. Perfect for new moms beginning this milestone.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about introducing solid foods for your baby:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which first foods will I try with my baby?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How will I watch for allergies or reactions?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What strategies can I use to make mealtime safe and fun?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. At what age is it generally recommended to start solid foods?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Around 6 months</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">2 months</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">12 months</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which food should be avoided before age 1?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Honey</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Pureed carrots</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Mashed bananas</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re taking important steps to safely introduce solids to your baby. Continue to Lesson 10 for more nutrition tips.
  </p>
  <a id="lesson10Btn" href="lesson10.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 10</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson10Btn = document.getElementById('lesson10Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson10Btn){
        lesson10Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 9})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
