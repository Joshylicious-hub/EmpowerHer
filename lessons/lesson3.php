...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 3 - Safe Sleep & Positioning</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 3: Safe Sleep & Positioning</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
        Discover the safest ways for your baby to sleep and rest—helping reduce risks and promoting healthy growth.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Safe Sleep Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Safe Sleep Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Safe sleep practices lower the risk of Sudden Infant Death Syndrome (SIDS) and help babies rest comfortably. 
          Positioning and environment both play a big role in keeping your newborn safe and secure.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          By creating a consistent and safe sleep routine, you support your baby’s development and your own peace of mind.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/sleeping1.jpg" alt="Safe baby sleep" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Key Safe Sleep Practices -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">On the Back</h3>
        <p class="text-gray-600 leading-relaxed">Always place your baby on their back to sleep, for naps and at night.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Clear Crib</h3>
        <p class="text-gray-600 leading-relaxed">Keep cribs free of pillows, toys, blankets, and stuffed animals.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Firm Mattress</h3>
        <p class="text-gray-600 leading-relaxed">Use a firm sleep surface with a fitted sheet—no soft bedding.</p>
      </div>
    </div>

    <!-- Section 3: Safe Positioning Tips -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/sleeping2.jpg" alt="Baby positioning" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Safe Positioning Tips</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Place baby on their back for every sleep.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Alternate your baby’s head position to prevent flat spots.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Supervised tummy time when awake helps build strength.</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
  <div>
    <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Sleep and Positioning</h2>
    <ul class="space-y-3 text-gray-700 slide-bottom">
      <li><span class="text-green-600 font-bold">✔ Do:</span> Always place your baby on their <strong>back to sleep</strong> to reduce the risk of SIDS.</li>
      <li><span class="text-green-600 font-bold">✔ Do:</span> Use a firm, flat mattress with a fitted sheet and keep the crib <strong>free of pillows, toys, and blankets</strong>.</li>
      <li><span class="text-green-600 font-bold">✔ Do:</span> Give your baby supervised <strong>tummy time</strong> while awake to strengthen neck and shoulder muscles.</li>
      <li><span class="text-red-500 font-bold">✘ Don’t:</span> Put your baby to sleep on their stomach or side.</li>
      <li><span class="text-red-500 font-bold">✘ Don’t:</span> Co-sleep in the same bed, as it increases the risk of suffocation.</li>
      <li><span class="text-red-500 font-bold">✘ Don’t:</span> Place stuffed animals, bumpers, or loose bedding in your baby’s sleep area.</li>
    </ul>
  </div>
  <div class="flex justify-center slide-left">
    <img src="../images/sleeping3.jpg" alt="Safe newborn sleep positioning" class="rounded-2xl shadow-lg w-full h-72 object-cover">
  </div>
</div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Safe Sleep & Positioning
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/U_B13ZyyeVI?autoplay=1&mute=1&vq=hd1080"
          title="The ABCD’s of Safe Sleep"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Learn why placing your baby alone, on their back, in a crib without loose bedding helps reduce the risk of SIDS and supports safer sleep.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">Think about your baby’s sleep setup:</p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Is the crib free of blankets, pillows, or toys?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Do I always place my baby on their back to sleep?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I add more supervised tummy time during the day?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is the safest sleep position for babies?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">On their back</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">On their stomach</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">On their side</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which item should NOT be in your baby’s crib?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Fitted sheet</button>
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Pillows and stuffed toys</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Firm mattress</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
     You’re creating a safe and healthy sleep routine for your little one. Continue to Lesson 4 to explore early bonding through play.
  </p>
  <a id="lesson4Btn" href="lesson4.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 4</a>
</div>
<!-- hanggang dito -->
  ...
  <script>
    ...
    function checkAnswer(button, isCorrect){
      if(isCorrect){
        ...
        alert("Not quite. Think again about safe sleep practices.");
      }
    }
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5){
      // Unlock Lesson 4 button visually
      if(lesson4Btn){
        lesson4Btn.classList.remove('opacity-50', 'pointer-events-none');
      }

      // Send AJAX request to mark Lesson 3 complete
      fetch('../mark_lesson_completed.php', { // ../ because lesson3.php is inside lessons/
        method: 'POST',
        headers: {'Content-Type':'application/json'},
        body: JSON.stringify({lesson_id: 3})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
          console.log("Lesson 3 marked complete");
        }
      });
    }
  });
