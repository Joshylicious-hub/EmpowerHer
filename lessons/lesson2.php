...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 2 - Understanding Newborn Cues</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 2: Understanding Newborn Cues</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Learn how to recognize your baby’s signals for hunger, sleep, and comfort—so you can respond with confidence.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Newborn Cues Are Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Babies can’t use words, but they communicate through sounds, movements, and expressions. Recognizing these signals helps reduce stress for both mother and child.  
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
           When you respond consistently to cues, your baby feels safe and understood—strengthening trust and emotional connection.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/newborn.jpg" alt="Parent holding baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Hunger Cues</h3>
        <p class="text-gray-600 leading-relaxed">Rooting, sucking on hands, or smacking lips are signs your baby is ready to feed.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Sleep Cues</h3>
        <p class="text-gray-600 leading-relaxed">Yawning, rubbing eyes, or becoming fussy mean your baby is tired and needs rest.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Comfort Cues</h3>
        <p class="text-gray-600 leading-relaxed">Crying, arching, or squirming can signal discomfort from gas, temperature, or a wet diaper.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/newborn1.jpg" alt="Parent playing with baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">How to Respond</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Feed your baby at early hunger signs—not just when crying.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Create a calm environment for sleep when you notice tired cues.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Gently comfort and check diapers or clothing if they seem uncomfortable.</li>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Newborn Cues</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span>  Feed your baby when you notice early hunger signs like sucking hands or rooting.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Put your baby to sleep when they show tired cues such as yawning or rubbing eyes.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Comfort your baby gently when they squirm, arch, or cry from discomfort.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Wait until your baby is crying loudly before responding to hunger.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore fussiness, as it may be an early signal of sleepiness or discomfort.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Overstimulate your baby when they show signs of tiredness or irritability.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/newborn2.jpg" alt="Mother bonding with baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  ...
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/RiV_uXOg6Bg?autoplay=1&mute=1&vq=hd1080"
  ...
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This video helps you recognize subtle signs of hunger, tiredness, and comfort in newborns—so you can respond early and nurture trust.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Think about your baby’s signals:</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> What cues does my baby show when hungry or tired?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I usually respond, and what could I try differently?</li>
         <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I feel when I correctly understand my baby’s needs?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Which of these is an early hunger cue?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Sucking on hands</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Yawning and rubbing eyes</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Crying loudly only</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. If your baby rubs their eyes and fusses, what does it likely mean?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">They are hungry</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">They are sleepy</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">They are ready to play</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Amazing Job, Mama! 🌸</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re learning to understand your baby’s unique language. Continue to Lesson 3 to explore sleep routines for newborns.
  </p>
  <a id="lesson3Btn" href="lesson3.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50">Go to Lesson 3</a>
</div>
  ...
  <script>
    ...
    function checkAnswer(button, isCorrect){
      if(isCorrect){
        ...
        alert("Correct! You're learning so well, Mama!");
      } else {
        button.classList.add('incorrect');
        button.classList.remove('correct');
        alert("Not quite. Think about the cues again.");
      }
    }
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5){
      // Unlock Lesson 3 button visually
      if(lesson3Btn){
        lesson3Btn.classList.remove('opacity-50', 'pointer-events-none');
      }

      // Send AJAX request to mark Lesson 2 complete
      fetch('../mark_lesson_completed.php', { // ../ because lesson2.php is inside lessons/
        method: 'POST',
      ...
      .then(data => {
        if(data.success){
          console.log("Lesson 2 marked complete");
        }
      });
    }
  });
