...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 17 - Making Friends & Sharing</title>
...
<body class="overflow-y-auto bg-gradient-to-br from-[#fff5f7] via-[#ffe6f0] to-[#ffe9f2]">
<!-- eto pinalitan ko -->
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 17: Making Friends & Sharing</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
     Learn how to help your child develop social skills, make friends, and practice sharing in everyday situations.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Social Skills Matter -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Social Skills Are Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Developing social skills helps children build friendships, communicate effectively, and navigate group settings confidently. For single mothers, encouraging these skills early fosters independence and emotional intelligence.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Positive social interactions also teach empathy, cooperation, and problem-solving, creating a strong foundation for lifelong relationships.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/friend.jpg" alt="Children playing together" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Simple Ways to Encourage Sharing -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Model Sharing</h3>
        <p class="text-gray-600 leading-relaxed">Show your child how to share toys and snacks. Children learn best by observing positive behaviors.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Praise Kindness</h3>
        <p class="text-gray-600 leading-relaxed">Recognize and celebrate when your child shares or helps others. Positive reinforcement strengthens social habits.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Playdates</h3>
        <p class="text-gray-600 leading-relaxed">Organize small play sessions with peers. These interactions teach turn-taking, negotiation, and teamwork.</p>
      </div>
    </div>

    <!-- Section 3: Everyday Social Activities -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/friends.jpg" alt="Children sharing toys" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Fun Activities to Practice Sharing</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Take turns with toys during playtime</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Work together on a simple craft or drawing</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Help set the table or clean up together</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Share stories or toys during group play</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Sharing</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage your child to take turns and wait patiently.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Praise efforts to share or cooperate with peers.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Model empathy by showing concern for others’ feelings.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force sharing—teach gentle negotiation instead.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Criticize mistakes harshly; learning takes time.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore conflicts—help your child solve them calmly.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/sharing.jpg" alt="Child sharing with another" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Making Friends & Sharing
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/AT8qLCmseuE?autoplay=1&mute=1&vq=hd1080"
          title="This Is The Way We Make Friends | Super Simple Songs"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    This song teaches toddlers how to say hello, take turns, share, and make friends—through fun puppetry and an easy melody.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about your child’s social interactions:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How does my child react when sharing or taking turns?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which activities help my child make friends most easily?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I encourage positive interactions at home and outside?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is a key benefit of teaching your child to share?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It helps them build friendships and empathy</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It guarantees they won’t have conflicts</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It makes them independent immediately</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which activity helps children practice sharing?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Taking turns with toys during playtime</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Keeping all toys to themselves</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Skipping group activities entirely</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <a id="lesson18Btn" href="lesson18.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 18</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson2Btn = document.getElementById('lesson17Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson18Btn){
        lesson18Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 17})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
