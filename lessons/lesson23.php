...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 23 - Teamwork & Friendship Skills</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 23: Teamwork & Friendship Skills</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
       Learn how to build positive relationships, communicate effectively, and work together with friends and peers.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Teamwork Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Teamwork & Friendship Skills Matter</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Teamwork and friendship skills help children develop empathy, communication, and problem-solving abilities. These skills are essential for forming strong relationships both in school and at home.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          By learning to collaborate and resolve conflicts, children gain confidence, feel supported, and build lasting friendships.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/teamwork.jpg" alt="Children working together" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Key Skills for Teamwork -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Communication</h3>
        <p class="text-gray-600 leading-relaxed">Listen actively, express your ideas clearly, and respond respectfully to others.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Collaboration</h3>
        <p class="text-gray-600 leading-relaxed">Work together to solve problems, share responsibilities, and support your teammates.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Conflict Resolution</h3>
        <p class="text-gray-600 leading-relaxed">Handle disagreements calmly, understand different perspectives, and find solutions together.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/friends.jpg" alt="Children playing and learning together" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Activities to Build Teamwork Skills</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Work on a group project or game with friends</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Practice sharing and taking turns</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Role-play scenarios to solve conflicts peacefully</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Encourage teamwork in sports or classroom activities</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Friendship</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Listen and show empathy to your friends</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Share responsibilities and celebrate successes together</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Solve disagreements calmly and fairly</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore others’ feelings or ideas</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Bully or exclude friends from activities</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Refuse to cooperate or blame others unfairly</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/collab.jpg" alt="Children resolving conflict" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Teamwork & Friendship Skills
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/WmLE2UMqshs?autoplay=1&mute=1&vq=hd1080"
          title="Wendy and Alex Hurry to Team Sports Games | Kids Learn Teamwork and Playing Together"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    In this video, Wendy and Alex discover how working together, encouraging teammates, and sharing roles make sports—and friendship—more fun and meaningful.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Think about your interactions with friends and classmates:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I handle disagreements with friends?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which teamwork activities do I enjoy most?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I support my friends better?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is an important skill for teamwork?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Communicating clearly with your group</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Working alone without input</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Avoiding responsibilities</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which action helps maintain good friendships?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Listening and showing empathy</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignoring friends’ ideas</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Blaming friends for mistakes</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  You’re learning how to build strong friendships and teamwork skills. Continue to the next lesson for more guidance.
  </p>
  <a id="lesson24Btn" href="lesson24.php" 
...
<!-- hanggang dito -->
  ...
  const lesson24Btn = document.getElementById('lesson24Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson24Btn){
        lesson24Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 23})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
