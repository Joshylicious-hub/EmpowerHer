...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  ...
  <title>Lesson 20 - Fun Physical Activities & Play</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 20:  Fun Physical Activities & Play</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
       Learn how engaging play and physical activities support your child’s growth, coordination, and emotional well-being.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Physical Play is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Playtime is crucial for developing motor skills, balance, and coordination. Active games also stimulate the brain, promote social skills, and create joyful memories.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          For single mothers, shared playtime strengthens the emotional bond while supporting your child’s healthy growth and confidence.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/physical.jpg" alt="Children playing" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Fun Activities to Try -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Outdoor Games</h3>
        <p class="text-gray-600 leading-relaxed">Activities like running, jumping, and tag improve coordination, strength, and endurance.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Creative Movement</h3>
        <p class="text-gray-600 leading-relaxed">Dancing, obstacle courses, and yoga foster balance, flexibility, and fun exploration.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Interactive Play</h3>
        <p class="text-gray-600 leading-relaxed">Games with balls, puzzles, or building blocks encourage problem-solving, teamwork, and hand-eye coordination.</p>
      </div>
    </div>

    <!-- Section 3: Daily Play Tips -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/activities.jpg" alt="Parent playing with child" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">How to Integrate Play Daily</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Set aside 20-30 minutes of dedicated active play</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Encourage free play outdoors when possible</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Turn chores into fun challenges (e.g., sorting toys, counting steps)</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Join your child in games to model enthusiasm and creativity</li>
        </ul>
      </div>
    </div>

    <!-- Section 4: Do's & Don'ts of Play -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Play</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage exploration and safe risk-taking</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Praise effort and creativity</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Rotate toys and activities to keep interest</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Force participation or push too hard</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Make play overly competitive</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore safety concerns during active play</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/early.jpg" alt="Parent supervising child play" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Fun Toddler Exercises You Can Do Together
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/PhTIVHrmryw?autoplay=1&mute=1&vq=hd1080"
          title="10 SIMPLE TODDLER EXERCISES – Fun Indoor Workout for Toddlers & Parents"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    A cheerful, easy routine you can follow with your toddler—great for developing movement skills, burning energy, and bonding as a family!
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Consider how you can make play a part of your child's daily routine:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which games excite my child the most?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I safely incorporate physical activity at home?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I join in to make play more interactive?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. Why is active play important for children?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It helps develop physical, cognitive, and social skills</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It replaces the need for sleep and meals</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">It makes children sit quietly for longer periods</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which activity encourages both creativity and movement?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Dancing and obstacle courses</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Watching TV quietly</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Eating snacks alone</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  ...
  <p class="text-lg mb-6 opacity-90 slide-bottom">
   You’re supporting your child's growth through play. Continue to Lesson 21 for more learning and fun activities.
  </p>
  <a id="lesson21Btn" href="lesson21.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 21</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson21Btn = document.getElementById('lesson21Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson21Btn){
        lesson21Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 20})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
