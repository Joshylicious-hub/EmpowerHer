...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  <title>Lesson 22 - Balancing Schoolwork & Screen Time</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 22: Balancing Schoolwork & Screen Time</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
    Learn practical strategies to help your child manage schoolwork efficiently while enjoying healthy screen time habits.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Balancing Schoolwork & Screen Time is Important</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Proper balance helps your child stay focused on learning while enjoying recreational screen activities in moderation. It reduces stress, improves academic performance, and encourages healthy habits.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          Establishing routines, setting clear limits, and monitoring screen time empowers your child to take responsibility for their learning and leisure time.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/screen.jpg" alt="Child studying with tablet" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Tips for Healthy Balance -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Set a Routine</h3>
        <p class="text-gray-600 leading-relaxed">Create a daily schedule that includes dedicated study time, breaks, and recreational screen time.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Use Timers</h3>
        <p class="text-gray-600 leading-relaxed">Set limits for screen use to prevent distractions and ensure homework completion.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Encourage Breaks</h3>
        <p class="text-gray-600 leading-relaxed">Short breaks between study sessions help maintain focus and reduce fatigue.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/gadget.jpg" alt="Child doing homework" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Practical Strategies You Can Try</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Set up a quiet study area free from distractions</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Allow screen time as a reward after completing schoolwork</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Use educational apps or programs to combine learning and screen time</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Track daily tasks using a planner or checklist</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts for Screen Time</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Set clear limits for recreational screen use</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Encourage educational content during screen time</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Monitor screen activity and discuss usage openly</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Allow screens to interfere with homework or sleep</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Use screens as the only form of reward or entertainment</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore excessive screen time that causes stress or fatigue</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/nigga.jpg" alt="Child using tablet responsibly" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Balancing Schoolwork & Screen Time
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/O0FwX9-6Ysg?autoplay=1&mute=1&vq=hd1080"
          title="How We Handle Screen Time: balancing screen & school life"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    In this video, a mother of ten shares down-to-earth tips for creating a screen-time routine that supports homework, family time, and wellness.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">
        Take a moment to think about your child’s daily routine:
      </p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How much time does my child spend on schoolwork vs recreational screen time?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Which strategies can I implement to improve focus and balance?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I involve my child in planning their screen and study schedule?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What is an effective way to balance schoolwork and screen time?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Use a schedule that includes both study and screen breaks</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Allow unlimited screen time before homework</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Avoid all recreational screen time entirely</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which strategy helps maintain focus while studying?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Take short breaks between study sessions</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Multitask with games while studying</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Skip all breaks to finish faster</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Great Work, Mama! 💖</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
     You’re helping your child develop healthy study habits and responsible screen use. Continue to Lesson 23 for more guidance.
  </p>
  <a id="lesson23Btn" href="lesson23.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 23</a>
</div>
<!-- hanggang dito -->
  ...
  const lesson23Btn = document.getElementById('lesson23Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson23Btn){
        lesson23Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 22})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
