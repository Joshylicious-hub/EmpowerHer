...
<link rel="icon" type="image/png" sizes="192x192" href="..images/logo7.png">
  ...
  <title>Lesson 8 - Building Secure Attachment</title>
...
<div id="utilityPanel" 
  ...
  <div class="relative z-10 text-center max-w-2xl px-6 top-6">
    <h1 class="text-5xl font-bold mb-4 slide-left">Lesson 8: Building Secure Attachment</h1>
    <p class="text-lg opacity-90 mb-6 slide-bottom">
      Discover how love, trust, and consistent care create a strong emotional foundation for your baby’s growth.
    </p>
...
<!-- hanggang dito yung hero -->
  ...
  <div id="content" class="max-w-6xl mx-auto px-6 py-12 space-y-20">
    ...
    <!-- Section 1: Why Secure Attachment Matters -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Why Secure Attachment Matters</h2>
        <p class="text-gray-600 leading-relaxed mb-6 slide-bottom">
          Secure attachment is built when your baby feels safe, loved, and cared for. It gives them confidence to explore the world while knowing you are their safe base.
        </p>
        <p class="text-gray-600 leading-relaxed slide-bottom">
          This emotional bond shapes how your child will form relationships, manage stress, and build self-esteem later in life.
        </p>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/bonding1.jpg" alt="Mother holding baby with love" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>

    <!-- Section 2: Signs of Secure Attachment -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Comfort in Your Arms</h3>
        <p class="text-gray-600 leading-relaxed">Baby calms when you hold or talk to them.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Smiles & Eye Contact</h3>
        <p class="text-gray-600 leading-relaxed">Shows joy when you smile, talk, or play together.</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-lg slide-bottom">
        <h3 class="text-xl font-semibold text-pink-500 mb-2">Exploring with Confidence</h3>
        <p class="text-gray-600 leading-relaxed">Feels secure enough to explore but checks back for reassurance.</p>
      </div>
    </div>

    <!-- Section 3: How to Build Secure Attachment -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div class="flex justify-center slide-left">
        <img src="../images/bonding2.jpg" alt="Parent bonding with baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">How to Build Secure Attachment</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Respond quickly and warmly when your baby cries.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Maintain gentle eye contact and smile often.</li>
          <li class="flex items-center"><span class="text-pink-500 mr-2">✔</span> Spend time cuddling, playing, and talking daily.</li>
        </ul>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div>
        <h2 class="text-3xl font-semibold text-gray-800 mb-4 slide-left">Do's & Don'ts of Attachment</h2>
        <ul class="space-y-3 text-gray-700 slide-bottom">
          <li><span class="text-green-600 font-bold">✔ Do:</span> Comfort your baby when they’re upset—it builds trust.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Create consistent routines for feeding, sleep, and play.</li>
          <li><span class="text-green-600 font-bold">✔ Do:</span> Use gentle words and touch to reassure your baby.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Ignore cries or delay comfort for long periods.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Be inconsistent—unpredictable care can cause insecurity.</li>
          <li><span class="text-red-500 font-bold">✘ Don’t:</span> Overwhelm your baby with too much noise or stimulation.</li>
        </ul>
      </div>
      <div class="flex justify-center slide-left">
        <img src="../images/bonding3.jpg" alt="Parent caring for baby" class="rounded-2xl shadow-lg w-full h-72 object-cover">
      </div>
    </div>
...
<div class="max-w-4xl mx-auto slide-bottom">
  <h2 class="text-3xl font-semibold text-gray-800 mb-6 text-center slide-left">
    Watch: Building Secure Attachment
  </h2>
  <iframe class="w-full rounded-2xl shadow-lg aspect-video"
          src="https://www.youtube.com/embed/V2599KVBTfo?autoplay=1&mute=1&vq=hd1080"
          title="Creating Secure Infant Attachment"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen></iframe>
  <p class="text-gray-600 mt-4 text-center slide-bottom">
    Observe gentle parenting techniques—like responsive holding, soothing, and eye contact—that help your baby feel loved, secure, and connected.
  </p>
</div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <p class="text-gray-600 leading-relaxed slide-bottom">Think about your caregiving:</p>
      <ul class="space-y-3 text-gray-700 slide-bottom">
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How do I comfort my baby when they cry?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> Do I have daily routines that help my baby feel safe?</li>
        <li class="flex items-start"><span class="text-pink-500 mr-2 mt-1">✔</span> How can I strengthen bonding moments each day?</li>
      </ul>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-6 slide-bottom">
      ...
      <!-- Question 1 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">1. What does secure attachment provide for your baby?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">A sense of safety and trust</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Faster crawling skills</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Longer nap times only</button>
        </div>
      </div>

      <!-- Question 2 -->
      <div class="space-y-4">
        <p class="text-gray-700 font-medium">2. Which of these helps strengthen attachment?</p>
        <div class="space-y-2">
          <button onclick="checkAnswer(this,true)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Responding warmly and consistently</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Ignoring cries to “toughen them up”</button>
          <button onclick="checkAnswer(this,false)" class="w-full border rounded-lg px-4 py-2 text-left hover:bg-pink-50">Keeping playtime very limited</button>
        </div>
      </div>
    </div>
...
<div class="cta-section w-full bg-pink-500 py-12 mt-12 text-center text-white slide-bottom">
  <h2 class="text-3xl font-bold mb-4 slide-left">Beautiful Work, Mama! 🌸</h2>
  <p class="text-lg mb-6 opacity-90 slide-bottom">
    You’re building a foundation of love and trust. Continue to Lesson 9 to discover playful ways to boost development.
  </p>
  <a id="lesson9Btn" href="lesson9.php" 
     class="bg-white text-pink-600 px-6 py-3 rounded-full text-lg font-semibold slide-bottom pointer-events-none opacity-50"> Go to Lesson 9</a>
</div>
<!-- hanggang dito -->
  ...
  <script>
    ...
    function checkAnswer(button, isCorrect){
      if(isCorrect){
        ...
        alert("Correct! Secure attachment helps babies feel safe and loved.");
      } else {
        button.classList.add('incorrect');
        button.classList.remove('correct');
        alert("Not quite. Think about what helps babies trust their caregivers.");
      }
    }

     // Make sure the "Go to Lesson 2" button has this ID
  const lesson9Btn = document.getElementById('lesson9Btn');
  ...
  window.addEventListener('scroll', () => {
    ...
    if(scrollTop + viewportHeight >= fullHeight - 5) {
      ...
      if(lesson9Btn){
        lesson9Btn.classList.remove('opacity-50', 'pointer-events-none');
      }
      ...
      fetch('../mark_lesson_completed.php', {  // note: ../ because lesson1 is inside lessons/
        ...
        body: JSON.stringify({lesson_id: 8})
      })
      .then(res => res.json())
      .then(data => {
        if(data.success){
